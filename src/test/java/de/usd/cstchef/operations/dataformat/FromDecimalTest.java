...
@OperationInfos(name = "FromDecimalTest", category = OperationCategory.DATAFORMAT, description = "Test class")
public class FromDecimalTest extends FromDecimal {
    ...
    public void setup(){
        ...
        // input = Test
        String input1 = "70 114 111 109 32 68 101 99 105 109 97 108";
        String output1 = "From Decimal";
